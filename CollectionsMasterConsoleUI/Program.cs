...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"We have the number you're searching for");
            }
            else
            {
                Console.WriteLine($"These are not the droids you're looking for");
                Console.WriteLine($"...These are no the droids I am looking for");
            }
        }
